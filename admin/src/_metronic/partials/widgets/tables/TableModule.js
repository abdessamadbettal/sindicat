...
const TableModule = ({className}) => {
    ...
    useEffect(() => {
        const fetchmodules = async () => {
            try {
                const {data} = await axios.get('http://localhost:8000/api/module')
    ...
    const handleSubmite = async (e) => {
        ...
        try {
            ...
            const {data} = await axios.put(`http://localhost:8000/api/module/${module.id}`, formData)
            setAlert(data.message)
            setTimeout(() => {
                setAlert('module updated successfully')
            }, 3000)
        } catch (error) {
            setError(error.message)
        }
    ...
    <div className={`card ${className}`}>
                    ...
                    <form className="form" method='POST' onSubmit={
                      ...
                      <div className="mb-10">
                        ...
                        <input
                          ...
                          className="form-control form-control-solid"
                          placeholder="coleur de la module"
                         defaultValue={module.coleur}
                        />
                       </div>
                      <div className="mb-10">
                        ...
                        <option defaultValue={module.langue} >{module.langue}</option>
                      ...
                      <div className="mb-10">
                        ...
                        aria-label="Select example">
                        <option defaultValue={module.status} >{module.status}</option>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>module Overview</span>
            ...
            <tbody>
              ...
              <tr key={module.id}>
                ...
                <td>
                  ...
                  <span className='text-muted fw-semibold d-block fs-7'>{module.specialite.name}</span>
                </td>
                <td>
                  <div className='d-flex flex-column w-100 me-2'>
                    <div className='d-flex flex-stack mb-2'>
                      <span className='text-muted me-2 fs-7 fw-semibold'>{
                        module.documentsCount 
                      } PDF </span>
                    </div>
                    <div className='progress h-6px w-100'>
                      <div
                        ...
                        role='progressbar'
                        style={{width: Math.floor(module.documentsCount * 0.3) }}
                      ></div>
                    </div>
                  </div>
                </td>
