...
const TableEcole = ({className}) => {
    ...
    useEffect(() => {
        const fetchecoles = async () => {
            try {
                const {data} = await axios.get('http://localhost:8000/api/ecole')
    ...
    const handleSubmite = async (e) => {
        ...
        try {
            ...
            formData.append('vile', editData.vile)
            ...
            const {data} = await axios.put(`http://localhost:8000/api/ecole/${ecole.id}`, formData)
            setAlert(data.message)
            setTimeout(() => {
                setAlert('ecole updated successfully')
            }, 3000)
        } catch (error) {
            setError(error.message)
        }
    ...
    <div className={`card ${className}`}>
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title">edit ecole</h5>
                    <div
                    ...
                    <form className="form" method='POST' onSubmit={
                      ...
                      <div className="mb-10">
                        ...
                        <input
                          ...
                          className="form-control form-control-solid"
                          placeholder="coleur de la ecole"
                         defaultValue={ecole.coleur}
                        />
                       </div>
                      <div className="mb-10">
                        ...
                        <option defaultValue={ecole.langue} >{ecole.langue}</option>
                      ...
                      <div className="mb-10">
                        ...
                        aria-label="Select example">
                        <option defaultValue={ecole.status} >{ecole.status}</option>
                      ...
                      <div className="mb-10">
                        ...
                        <textarea
                          ...
                          rows="12" cols="33"
                          name='description'
                         defaultValue={ecole.description}
                        />
                       </div>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>ecole Overview</span>
            ...
            <tbody>
              ...
              <tr key={ecole.id}>
                ...
                <td>
                  ...
                  <span className='text-muted fw-semibold d-block fs-7'>{ecole.name}</span>
                </td>
                <td>
                  <div className='d-flex flex-column w-100 me-2'>
                    <div className='d-flex flex-stack mb-2'>
                      <span className='text-muted me-2 fs-7 fw-semibold'>{
                        ecole.documentsCount 
                      } PDF </span>
                    </div>
                    <div className='progress h-6px w-100'>
                      <div
                        ...
                        role='progressbar'
                        style={{width: Math.floor(ecole.documentsCount * 0.3) }}
                      ></div>
                    </div>
                  </div>
                </td>
